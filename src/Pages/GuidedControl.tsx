...
import MapComponent from '../Components/GuideMap'
...
const Guide = () => {
    ...
    const [shouldClearOverlays, setShouldClearOverlays] = useState(false);

    const handleRtlConfirmation = () => {
        console.log('handleRtlConfirmation called');
        setShouldClearOverlays(true);
    };
                        ...
                        <TouchableWithoutFeedback onPress={handleCameraToggle}>
                            <View style={styles.mapSmall}>
                                <MapComponent
                                    ref={mapRef}
                                    mapType={mapType}
                                    clearOverlays={shouldClearOverlays}
                                    onOverlaysCleared={() => setShouldClearOverlays(false)}
                                />
                            </View>
